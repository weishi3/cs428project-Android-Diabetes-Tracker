...
public class ExpandableListAdapterWithImages extends BaseExpandableListAdapter {
    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, List<String>> _listDataChild;
    private HashMap<String, Drawable> _listImageChild;

    /**
     * The ExpandableListAdapter constructor,saves the android context,listDataHeader, listChildData and listImageChild
     *
     ...
     * @param listImageChild a hashMap from header names to its image
     */
    public ExpandableListAdapterWithImages(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData, HashMap<String, Drawable> listImageChild) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.diet_low_list_item, null);
        }
        ImageView imageViewChild = (ImageView) convertView.findViewById(R.id.image);
        TextView txtListChild = (TextView) convertView.findViewById(R.id.lblListItem);

        txtListChild.setText(childText);
        imageViewChild.setImageDrawable(_listImageChild.get(this._listDataHeader.get(groupPosition)));
        return convertView;
    }
